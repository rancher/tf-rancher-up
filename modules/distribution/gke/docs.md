...
|------|-------------|------|---------|:--------:|
| <a name="input_cluster_version"></a> [cluster\_version](#input\_cluster\_version) | Supported Google Kubernetes Engine for Rancher Manager | `string` | `"1.26.7-gke.500"` | no |
